...
Inspite of its great success in empirical work, the gravity equation was criticized due to its absence of theoretical foundations, 
which makes interpretations and counterfactual simulations impossible. 

We focus on the Eaton-Kortum (henceforth EK) model and its applications, originated from the Ricardo model 
and provides a powerful framework to quantify trade flows in the real world. 
