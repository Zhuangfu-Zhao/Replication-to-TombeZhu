...
\begin{equation*}
    U^i = \alpha_1 \ln c^i_1 + \alpha_2 \ln c^i_2. 
\end{equation*}
where $i\in\{H,F\}$. 
...
\begin{align*}
    & \max \alpha_1 \ln c^i_1 + \alpha_2 \ln c^i_2, \\ 
    & \mathrm{s.t.}\quad p^i_1 c^i_1 + p^i_2 c^i_2 \leq w^i l^i, 
\end{align*}
where $l^i = l^i_1 + l^i_2$. 

The optimization problem for firms (sectors) in country $i$ is given by 
\begin{align*}
    & \max_{l^i_1} p^i_1 z^i_1 l^i_1 - w^i l^i_1, \\ 
    & \max_{l^i_2} p^i_2 z^i_2 l^i_2 - w^i l^i_2. 
\end{align*}

\section{The Ricardian model with a continuum of goods} 
